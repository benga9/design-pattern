...
namespace A15_Ex02_BenGalili_039711056_AmitPaz_040305179
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            LoggerProxy.Instance.LogInfo("App Init");
        }
        ...
        private void buttonLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    fetchUserInfo();
                    LoggerProxy.Instance.LogInfo("LoggedIn");
                }
                else
                {
            ...
            catch (Facebook.FacebookOAuthException ex)
            {
                ...
                LoggerProxy.Instance.LogError(msg);
                MessageBox.Show(msg);
            }
            catch (Exception ex)
            {
        ...
        private void fetchUserInfo()
        {
            ...
            LoggerProxy.Instance.LogInfo("Fetched user info: {0}", ViewModel.LoggedInUser.Name);
        }

        private void buttonPostStatus_Click(object sender, EventArgs e)
        {
            ViewModel.LoggedInUser.PostStatus(textBoxStatus.Text);
            LoggerProxy.Instance.LogInfo("Post status: {0}", textBoxStatus.Text);
        }
        ...
        private void linkNewsFeed_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Fetched user feed");
        }
        ...
        private void linkFriends_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Fetched user friends");
        }
        ...
        private void displaySelectedFriend(ListBox i_ListBox, PictureBox i_PictureBox)
        {
            if (i_ListBox.SelectedItems.Count == 1)
            {
                ...
                LoggerProxy.Instance.LogInfo("Display friend picture: {0}", selectedFriend.Name);
            }
        }
        ...
        private void linkCheckins_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Fetched user chechins");
        }
        ...
        private void labelEvents_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Fetched user event");
        }
        ...
        private void listBoxEvents_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listBoxEvents.SelectedItems.Count == 1)
            {
                ...
                LoggerProxy.Instance.LogInfo("Display event: {0}", selectedEvent.Name);
            }
        }
        ...
        private void buttonFilter_Click(object sender, EventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Display friends statuses that contains: {0}", textBoxFilterFriendsStatuses.Text);
        ...
        private void displayFriendOfSelectedStatus()
        {
            if (listBoxFilteredStatuses.SelectedItems.Count == 1)
            {
                ...
                LoggerProxy.Instance.LogInfo("Display status owner picture: {0}", selectedFriend.Name);
            }
        }
        ...
        private void buttonEventFilter_Click(object sender, EventArgs e)
        {
            ...
            LoggerProxy.Instance.LogInfo("Display friends event that contains: {0}", textBoxFriendsEventFilter.Text);
        }
        ...
        private void listFriendsEventsFiltered_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listFriendsEventsFiltered.SelectedItems.Count == 1)
            {
                ...
                LoggerProxy.Instance.LogInfo("Display event ditails picture: {0}", fbEvent.Name);
            }
        }
        ...
        private void buttonJoinEvent_Click(object sender, EventArgs e)
        {
            if (listFriendsEventsFiltered.SelectedItems.Count == 1)
            {
                ...
                if (fbEvent.Privacy.Equals(Event.ePrivacy.Open) && fbEvent.Respond(Event.eRsvpType.Attending))
                {
                    ...
                    LoggerProxy.Instance.LogInfo("{0} joined event: {1}", ViewModel.LoggedInUser.Name, fbEvent.Name);
                }
                else
                {
                    MessageBox.Show("You cannot join this event");
                    LoggerProxy.Instance.LogError("{0} can't join event - {1}, becuse of privacy issues", ViewModel.LoggedInUser.Name, fbEvent.Name);
                }
            }
        }
    }
